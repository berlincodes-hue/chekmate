            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="ml-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <!-- Theme Toggle -->
                            <form method="POST" action="{{ route('theme.toggle') }}" class="w-full" id="theme-toggle-form">
                                @csrf
                            ...
                            <script>
                                document.getElementById('theme-toggle-form').addEventListener('submit', function(e) {
                                    e.preventDefault();
